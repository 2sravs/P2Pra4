...
namespace WebAPIproject4.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class StudentsController : ControllerBase
    {
        private readonly project4DbContext _context;

        public StudentsController(project4DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Students>> PostStudents(Students students)
        {
          if (_context.Students == null)
          {
              return Problem("Entity set 'project4DbContext.Students'  is null.");
          }
